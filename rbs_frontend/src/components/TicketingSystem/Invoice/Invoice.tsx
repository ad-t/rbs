...
//       const details = this.props.ticketDetails.filter(
//         (x) => x.typeId === ticket.id
//       );
//       if (details.length) {
//         seats.push({
//           details,
...
//       `${process.env.REACT_APP_API_URL}/shows/${this.props.selectedShow}/seats`,
//       {
//         method: 'POST',
//         headers: {
...
//       `${process.env.REACT_APP_API_URL}/orders/${id}/paypal-setup`,
//       {
//         method: 'POST',
//       }
//     );
...
//       `${process.env.REACT_APP_API_URL}/orders/${this.state.orderID}/paypal-capture`,
//       {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
...
//     const verify = await fetch(
//       `${process.env.REACT_APP_API_URL}/orders/${this.state.orderID}/square-verify-payment`,
//       {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
...
//                   <List.Item>
//                     Total Cost: $
//                     {(totalPrice + this.handlingFee(totalPrice)).toFixed(2)}
//                   </List.Item>
//                 </List>
//               </div>
...
//                   times, except for momentary eating or drinking or if you have
//                   a relevant medical condition.
//                 </li>
//                 <li>
//                   Do <strong>not</strong> attend if you have symptoms of
//                   COVID-19, or you are required to self-isolate or quarantine.
//                 </li>
//                 <li>
//                   You will follow the{' '}
//                   <a
...
//                 </li>
//                 <li>
//                   Ticket exchanges may be available (subject to capacity).
//                   Please contact us ASAP if you need to reschedule.
//                 </li>
//                 <li>
//                   Tickets will be refunded in full (minus handling fees and
//                   surcharges) if the event is cancelled, or you are required to
//                   self-isolate due to COVID-19 regulations. Any other refunds
//                   will be at our sole discretion. (This does not affect your
